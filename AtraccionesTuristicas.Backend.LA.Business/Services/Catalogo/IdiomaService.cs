...
public sealed class IdiomaService : IIdiomaService
    {
        ...
        private static void Validate(string codigo, string descripcion) { var errors = new List<string>(); Support.Guard.Required(codigo, "Codigo", errors); Support.Guard.Required(descripcion, "Descripcion", errors); Support.Guard.MaxLength(codigo, 10, "Codigo", errors); Support.Guard.MaxLength(descripcion, 80, "Descripcion", errors); Support.Guard.ThrowIfAny(errors); }
    }
