...
public sealed class DestinoService : IDestinoService
    {
        ...
        private static void Validate(string nombre, string pais) { var errors = new List<string>(); Support.Guard.Required(nombre, "Nombre", errors); Support.Guard.Required(pais, "Pais", errors); Support.Guard.MaxLength(nombre, 150, "Nombre", errors); Support.Guard.MaxLength(pais, 100, "Pais", errors); Support.Guard.ThrowIfAny(errors); }
    }
