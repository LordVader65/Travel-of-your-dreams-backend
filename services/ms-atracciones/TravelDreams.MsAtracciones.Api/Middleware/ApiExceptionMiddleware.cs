...
namespace TravelDreams.MsAtracciones.Api.Middleware;
...
public sealed class ApiExceptionMiddleware
{
    ...
    private static int ResolveStatusCode(Exception ex)
    {
        ...
        if (message.Contains("cupos") || message.Contains("capacidad") || message.Contains("ya existe")) return StatusCodes.Status409Conflict;
