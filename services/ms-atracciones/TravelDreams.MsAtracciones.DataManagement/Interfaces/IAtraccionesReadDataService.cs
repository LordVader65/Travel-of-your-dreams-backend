...
public interface IAtraccionesReadDataService
{
    ...
    Task<IReadOnlyList<HorarioPublicoDataModel>> ListarHorariosPorAtraccionAsync(Guid atraccionGuid, DateOnly? fecha = null, CancellationToken cancellationToken = default);
