...
namespace TravelDreams.MsFacturacion.Api.Middleware;
...
public sealed class ApiExceptionMiddleware
{
    ...
    private static int ResolveStatusCode(Exception ex)
    {
        ...
        if (message.Contains("no encontrado") || message.Contains("no encontrada") || message.Contains("no existe")) return StatusCodes.Status404NotFound;
        if (message.Contains("no coincide") || message.Contains("expirada") || message.Contains("pendiente") || message.Contains("aprobado") || message.Contains("pagada") || message.Contains("confirmada")) return StatusCodes.Status409Conflict;
